package com.study.playground.common.util;
...
public final class AvroSerializer {
    ...
    public static byte[] serialize(SpecificRecord record) {
        try {
            ...
            throw new RuntimeException("Failed to serialize Avro record: " + record.getClass().getSimpleName(), e);
        }
    }
    ...
    public static <T extends SpecificRecord> T deserialize(byte[] data, Schema schema) {
        try {
            ...
            throw new RuntimeException("Failed to deserialize Avro record: " + schema.getName(), e);
        }
    }
    ...
    public static String toJson(SpecificRecord record) {
        try {
            ...
            throw new RuntimeException("Failed to convert Avro record to JSON: " + record.getClass().getSimpleName(), e);
        }
    }
}
