...
**파일**: `docker/connect/jenkins-webhook.yaml`
...
| 파일 | 역할 |
|------|------|
| `docker/connect/jenkins-command.yaml` | 토픽 → Jenkins REST API |
| `docker/connect/jenkins-webhook.yaml` | Jenkins HTTP 웹훅 → 토픽 |
