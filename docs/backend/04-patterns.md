...
| 6 | Redpanda Connect | HTTP↔Kafka 브릿지 (전송만, 비즈니스 로직 없음) | [patterns/06-redpanda-connect.md](patterns/06-redpanda-connect.md) |
...
| 10 | Dynamic Connector Management | 런타임 Connect 스트림 등록/삭제, DB 영속화 | [patterns/10-dynamic-connector.md](patterns/10-dynamic-connector.md) |
