...
```sql
INSERT INTO public.support_tool (id, name, url, username, credential, active, auth_type, category, implementation)
VALUES (99, 'Fake Jenkins', 'http://localhost:1', 'admin', 'admin', true, 'BASIC', 'CI_CD_TOOL', 'JENKINS');
```
