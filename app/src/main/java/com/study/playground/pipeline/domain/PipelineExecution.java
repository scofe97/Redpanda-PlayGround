 ...
 *
 * <p>{@link #steps}는 실행 시 함께 로드되는 연관 컬렉션이다.
...
public class PipelineExecution {
    ...
    /** 첫 번째 스텝이 시작된 시각. PENDING에서 RUNNING으로 전이될 때 기록된다. */
    ...
    /**
     * 파이프라인 실패 원인 메시지.
     * SUCCESS인 경우 null이다. 실패한 스텝의 에러 메시지를 상위로 전파한다.
     */
    ...
    /**
     * 이 실행에 속한 스텝 목록. stepOrder 오름차순으로 정렬되어 있다.
